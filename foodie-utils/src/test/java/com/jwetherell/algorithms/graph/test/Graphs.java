...
public class Graphs {
    ...
    private static class DirectedGraph {
        ...
        final Edge<Integer> e3_4 = new Edge<Integer>(11, v3, v4);
        final Edge<Integer> e3_6 = new Edge<Integer>(2, v3, v6);
        final Edge<Integer> e6_5 = new Edge<Integer>(9, v6, v5);
        final Edge<Integer> e6_8 = new Edge<Integer>(14, v6, v8);
        final Edge<Integer> e4_5 = new Edge<Integer>(6, v4, v5);
        final Edge<Integer> e4_7 = new Edge<Integer>(16, v4, v7);
        final Edge<Integer> e1_8 = new Edge<Integer>(30, v1, v8);
        {
            edges.add(e1_2);
            edges.add(e1_3);
            edges.add(e1_6);
        ...
        final Graph<Integer> graph = new Graph<Integer>(TYPE.DIRECTED, verticies, edges);
    }
    ...
    private static class DirectedWithNegativeWeights {
        ...
        final List<Edge<Integer>> edges = new ArrayList<Edge<Integer>>();
        final Edge<Integer> e1_4 = new Edge<Integer>(2, v1, v4);  // w->z
        final Edge<Integer> e2_1 = new Edge<Integer>(6, v2, v1);  // x->w
        final Edge<Integer> e2_3 = new Edge<Integer>(3, v2, v3);  // x->y
        final Edge<Integer> e3_1 = new Edge<Integer>(4, v3, v1);  // y->w
        final Edge<Integer> e3_4 = new Edge<Integer>(5, v3, v4);  // y->z
        final Edge<Integer> e4_2 = new Edge<Integer>(-7, v4, v2); // z->x
        final Edge<Integer> e4_3 = new Edge<Integer>(-3, v4, v3); // z->y
        {
            edges.add(e1_4);
            edges.add(e2_1);
            edges.add(e2_3);
    ...
    private Map<Vertex<Integer>, Graph.CostPathPair<Integer>> getIdealUndirectedPath(UndirectedGraph undirected) {
        final HashMap<Vertex<Integer>, Graph.CostPathPair<Integer>> idealUndirectedPath = new HashMap<Vertex<Integer>, Graph.CostPathPair<Integer>>();
        {
            final int cost = 11;
            final List<Edge<Integer>> list = new ArrayList<Edge<Integer>>();
        ...
        }
        {
            ...
            list.add(undirected.e1_3);
            list.add(undirected.e3_6);
            list.add(new Edge<Integer>(9, undirected.v6, undirected.v5));
            final Graph.CostPathPair<Integer> path = new Graph.CostPathPair<Integer>(cost, list);
    ...
    // Ideal directed path
    private Map<Vertex<Integer>, Graph.CostPathPair<Integer>> getIdealDirectedPath(DirectedGraph directed) {
        final Map<Vertex<Integer>, Graph.CostPathPair<Integer>> idealDirectedPath = new HashMap<Vertex<Integer>, Graph.CostPathPair<Integer>>();
        {
            final int cost = 11;
            final List<Edge<Integer>> list = new ArrayList<Edge<Integer>>();
        ...
        }
        {
            ...
            list.add(directed.e1_3);
            list.add(directed.e3_6);
            list.add(new Edge<Integer>(9, directed.v6, directed.v5));
            final Graph.CostPathPair<Integer> path = new Graph.CostPathPair<Integer>(cost, list);
    ...
    private Map<Vertex<Integer>, Graph.CostPathPair<Integer>> getIdealDirectedNegWeight(DirectedWithNegativeWeights directedWithNegWeights) {
        final Map<Vertex<Integer>, Graph.CostPathPair<Integer>> idealDirectedNegWeight = new HashMap<Vertex<Integer>, Graph.CostPathPair<Integer>>();
        {
            final int cost = -2;
            final List<Edge<Integer>> list = new ArrayList<Edge<Integer>>();
    ...
    public void testDijstraUndirected() {
        ...
        {   // UNDIRECTED GRAPH
            final Map<Vertex<Integer>, Graph.CostPathPair<Integer>> map1 = Dijkstra.getShortestPaths(undirected.graph, start);
    ...
    public void testBellmanFordUndirected() {
        ...
        final Vertex<Integer> end = undirected.v5;
        {
            final Map<Vertex<Integer>, Graph.CostPathPair<Integer>> map2 = BellmanFord.getShortestPaths(undirected.graph, start);
    ...
    public void testPrimUndirected() {
        ...
        Vertex<Integer> start = undirected.v1;
        {
            final Graph.CostPathPair<Integer> resultMST = Prim.getMinimumSpanningTree(undirected.graph, start);
            {
                ...
                list.add(undirected.e3_6);
                list.add(new Edge<Integer>(9, undirected.v6, undirected.v5));
                list.add(new Edge<Integer>(6, undirected.v5, undirected.v4));
            ...
            final Vertex<Integer> cv1 = new Vertex<Integer>(1);
            cyclicVerticies.add(cv1);
            final Vertex<Integer> cv2 = new Vertex<Integer>(2);
            cyclicVerticies.add(cv2);
            final Vertex<Integer> cv3 = new Vertex<Integer>(3);
            cyclicVerticies.add(cv3);
            final Vertex<Integer> cv4 = new Vertex<Integer>(4);
            cyclicVerticies.add(cv4);
            final Vertex<Integer> cv5 = new Vertex<Integer>(5);
            cyclicVerticies.add(cv5);

            final List<Edge<Integer>> cyclicEdges = new ArrayList<Edge<Integer>>();
            final Edge<Integer> ce1_2 = new Edge<Integer>(3, cv1, cv2);
            cyclicEdges.add(ce1_2);
            final Edge<Integer> ce2_3 = new Edge<Integer>(2, cv2, cv3);
            cyclicEdges.add(ce2_3);
            final Edge<Integer> ce3_4 = new Edge<Integer>(4, cv3, cv4);
            cyclicEdges.add(ce3_4);
            final Edge<Integer> ce4_1 = new Edge<Integer>(1, cv4, cv1);
            cyclicEdges.add(ce4_1);
            final Edge<Integer> ce4_5 = new Edge<Integer>(1, cv4, cv5);
            ...
            final Graph.CostPathPair<Integer> pair4 = Prim.getMinimumSpanningTree(cyclicUndirected, start);
            {
                ...
                final int cost = 7;
                final List<Edge<Integer>> list = new ArrayList<Edge<Integer>>();
                list.add(new Edge<Integer>(1, cv1, cv4));
                list.add(ce4_5);
                list.add(ce1_2);
                list.add(ce2_3);
    ...
    public void testDijkstraDirected() {
        ...
        final Vertex<Integer> start = directed.v1;
        final Vertex<Integer> end = directed.v5;
        final Map<Vertex<Integer>, Graph.CostPathPair<Integer>> map1 = Dijkstra.getShortestPaths(directed.graph, start);
    ...
    public void testBellmanFordDirected() {
        ...
        final Map<Vertex<Integer>, Graph.CostPathPair<Integer>> map2 = BellmanFord.getShortestPaths(directed.graph, start);
    ...
    public void testDijstraDirectedWihtNegativeWeights() {
        ...
        {   // DIRECTED GRAPH (WITH NEGATIVE WEIGHTS)
            final Vertex<Integer> start = directedWithNegWeights.v1;
            final Vertex<Integer> end = directedWithNegWeights.v3;
            final Map<Vertex<Integer>, Graph.CostPathPair<Integer>> map1 = BellmanFord.getShortestPaths(directedWithNegWeights.graph, start);
    ...
    public void cycleCheckOnUndirected() {
        ...
        {   // UNDIRECTED GRAPH
            ...
            final Vertex<Integer> cv6 = new Vertex<Integer>(6);
            cycledVerticies.add(cv6);

            final List<Edge<Integer>> cycledEdges = new ArrayList<Edge<Integer>>();
            final Edge<Integer> ce1_2 = new Edge<Integer>(7, cv1, cv2);
            cycledEdges.add(ce1_2);
            final Edge<Integer> ce2_4 = new Edge<Integer>(15, cv2, cv4);
            cycledEdges.add(ce2_4);
            final Edge<Integer> ce3_4 = new Edge<Integer>(11, cv3, cv4);
            cycledEdges.add(ce3_4);
            final Edge<Integer> ce3_6 = new Edge<Integer>(2, cv3, cv6);
            cycledEdges.add(ce3_6);
            final Edge<Integer> ce5_6 = new Edge<Integer>(9, cv5, cv6);
            cycledEdges.add(ce5_6);
            final Edge<Integer> ce4_5 = new Edge<Integer>(6, cv4, cv5);
    ...
    public void topologicalSortOnDirectedGraph() {
        {   // DIRECTED GRAPH
            ...
            final List<Edge<Integer>> edges = new ArrayList<Edge<Integer>>();
            final Edge<Integer> ce1_2 = new Edge<Integer>(1, cv1, cv2);
            edges.add(ce1_2);
            final Edge<Integer> ce2_4 = new Edge<Integer>(2, cv2, cv4);
            edges.add(ce2_4);
            final Edge<Integer> ce4_3 = new Edge<Integer>(3, cv4, cv3);
            edges.add(ce4_3);
            final Edge<Integer> ce3_6 = new Edge<Integer>(4, cv3, cv6);
            edges.add(ce3_6);
            final Edge<Integer> ce5_6 = new Edge<Integer>(5, cv5, cv6);
            edges.add(ce5_6);
            final Edge<Integer> ce4_5 = new Edge<Integer>(6, cv4, cv5);
            edges.add(ce4_5);

            final Graph<Integer> digraph = new Graph<Integer>(TYPE.DIRECTED, verticies, edges);
            ...
            final List<Vertex<Integer>> results2 = new ArrayList<Vertex<Integer>>(results1.size());
            {  // Ideal sort
                results2.add(cv6);
                results2.add(cv3);
                results2.add(cv5);
            ...
            // Compare results
            {
                ...
                while (iter1.hasNext() && iter2.hasNext()) {
                    final Vertex<Integer> v1 = (Vertex<Integer>) iter1.next();
                    final Vertex<Integer> v2 = (Vertex<Integer>) iter2.next();
    ...
    public void testAStarUndirected() {
        final UndirectedGraph undirected = new UndirectedGraph();
        final Vertex<Integer> start = undirected.v1;
        final Vertex<Integer> end = undirected.v8;
        {   // UNDIRECTED GRAPH
            final AStar<Integer> aStar = new AStar<Integer>();
            final List<Edge<Integer>> path = aStar.aStar(undirected.graph, start, end);
            final List<Edge<Integer>> ideal = getIdealUndirectedPath(undirected).get(end).getPath();
    ...
    public void testAStarDirected() {
        final DirectedGraph directed = new DirectedGraph();
        final Vertex<Integer> start = directed.v1;
        final Vertex<Integer> end = directed.v8;
        {   // DIRECTED GRAPH
            final AStar<Integer> aStar = new AStar<Integer>();
            final List<Edge<Integer>> path = aStar.aStar(directed.graph, start, end);
            final List<Edge<Integer>> ideal = getIdealDirectedPath(directed).get(end).getPath();
            assertTrue("A* path error. path="+path+" idealPathPair="+ideal, path.equals(ideal));
        }
    }
