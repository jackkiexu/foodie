...
{
    private static Logger logger = Logger.getLogger(KBTree.class);
    ...
    public KBTree(Comparator<K> kComparator, int t)
    {
        this(kComparator);
        this.t = t;
        minKeySize = t - 1;
    ...
    public static void main(String[] args)
    {
        ...
        KBTree<Integer, Integer> btree = new KBTree<Integer, Integer>(3);
        List<Integer> save = new ArrayList<Integer>();
        for(int i = 0; i < 100; ++ i)
        {
            int r = random.nextInt(100);
//            r = Integer.parseInt(""+str.charAt(i));
            save.add(r);
