package com.lami.foodie.asm;

/**
 * Created by xjk on 11/18/17.
 */
...
import com.lami.foodie.transaction.SimpleServiceImpl;
...
//                System.out.println("desc->"+method.desc+":"+m.desc);
    ...
    public static void main(String[] args) throws IOException {
        for (Method m : SimpleAdvice.class.getDeclaredMethods()) {
            List<String> list = getMethodParamNames(SimpleAdvice.class, m);
